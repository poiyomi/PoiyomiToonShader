Shader ".poiyomi/Toon/Extras/Cutout"
{
    Properties
    {
        ...
        */
        ...
        /*
        [HideInInspector] m_refractionOptions ("Refraction", Float) = 0
        _IndexOfRefraction ("Index of Refraction--hover=How much light is bent as it passes through the mesh", Range(0, 3)) = 1.333333
        _RefractionOpacityMask ("Opacity Mask--hover=Contols how opaque an area is. White = 1 opacity, black = 0 opacity", 2D) = "white" { }
        _RefractionOpacity ("Opacity--hover=How transparent the material is", Range(0, 1)) = 0.7
        */
        ...
        _PanosphereTexture ("Panoshpere Texture--hover=The texture to be projected on the panosphere. If this appears too zomed in simply alter the tiling options for the texture.", 2D) = "white" { }
        _PanoMapTexture ("Pano Map Texture--hover=Where the panosphere effect should take place on the material.", 2D) = "white" { }
        _PanoEmission ("Pano Emission--hover=Makes the panosphere emissive / glow. the higher the value the more it will glow. Note: You can not glow in worlds without post processing bloom.", Range(0, 10)) = 0
        _PanoBlend ("Pano Blend--hover=How the panosphere effect is blended into your base material. 0.0 = only see base material 0.5 = even mix of base and pano 1.0 = only see pano", Range(0, 1)) = 0
        _PanosphereColor ("Panosphere Color--hover=Tints the panosphere effect", Color) = (1, 1, 1, 1)
        _PanosphereScroll ("Panosphere Scrolling--hover=Pans the panosphere texture", Vector) = (0, 0, 0, 0)
