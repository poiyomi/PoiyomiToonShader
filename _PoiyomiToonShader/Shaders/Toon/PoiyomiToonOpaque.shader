Shader ".poiyomi/Toon/Default/Opaque"
{
    Properties
    {
        ...
        _DetailMask ("Detail Mask (R:Texture, G:Normal)--{reference_property:_MainDetailNormalPan}", 2D) = "white" { }
        ...
        [Normal][PanningTexture]_DetailNormalMap ("Detail Normal", 2D) = "bump" { }
