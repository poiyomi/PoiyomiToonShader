    ...
    float3 calculateSpecular(in float4 albedo)
    {
        ...
        finalSpecular *= specularMask;
            ...
            if (_SpecularType1 == 1) // Realistic
            {
                ...
                finalSpecular1 = calculateNewSpecular(specularMap1.rgb, _SmoothnessFrom1, realisticAlbedo1, _SpecularTint1, metallic1, _SpecularSmoothness1 * specularMap1.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, attenuation);
            }
