Shader ".poiyomi/Toon/Simple/Transparent"
{
    Properties
    {
        ...
        [HideInInspector] shader_master_label ("<color=#ff0000ff>❤</color> <color=#000000ff>Poiyomi Simple V5.3</color> <color=#ff0000ff>❤</color>", Float) = 0
        ...
        [HideInInspector][Toggle(_)]_MainAlphaToCoverage ("Alpha To Coverage", Float) = 1
        [HideInInspector]_MainMipScale ("Mip Level Alpha Scale", Range(0, 1)) = 0.25
        /*
        ...
        */
        ...
        /*
        [HideInInspector] m_outlineOptions ("Outlines", Float) = 1
